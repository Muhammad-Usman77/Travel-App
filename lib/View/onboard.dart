...
import 'package:travelui/Model/onboard_model.dart';
import 'package:travelui/Utils/const.dart';
import 'package:travelui/View/travel_home_screen.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Text.rich(TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: "${onboard[currentIndex].text1}\n",
                        style: const TextStyle(fontWeight: FontWeight.w200),
                      ),
                      TextSpan(
                        text: "${onboard[currentIndex].text2}\n",
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (_) => TravelHomeScreen()),
                          (route) => false);
                    },
