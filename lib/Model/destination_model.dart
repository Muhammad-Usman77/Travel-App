import 'package:travelui/Model/facelities_model.dart';
...
List<Destination> destinations = [
  ...
  Destination(
    ...
    category: 'hotel',
    image:
        "https://assets-api.kathmandupost.com/thumb.php?src=https://assets-cdn.kathmandupost.com/uploads/source/news/2023/money/0moneylocal2hotel-1691592512.jpg&w=900&height=601",
  ...
  Destination(
    ...
    category: 'hotel',
    image:
        "https://cf.bstatic.com/xdata/images/hotel/max1024x768/160737100.jpg?k=fc3ba3c9d68b03c2dd22e256d7a4351d1a018de68648de68999116d215b67558&o=&hp=1",
  ...
  Destination(
    ...
    name: "Gunung Kerinci",
    image:
        "https://www.wildsumatra.com/wp-content/uploads/2016/10/mt-kerinci.jpg",
    category: "mountain",
  ...
  Destination(
    ...
    members: [members[0], members[2], members[1]],
    image:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Pashupatinath2.jpg/1200px-Pashupatinath2.jpg",
    location: "Kathmandu Nepal ",
    description:
  ...
  Destination(
    ...
    category: 'beach',
    image:
        "https://gomandalika.com/wp-content/uploads/2023/10/Kuta-Mandalika-4.jpg",
    facilities: [facilities[6], facilities[1], facilities[2], facilities[3]],
    location: "Lombok, Indonesia",
    members: [members[0], members[2], members[1]],
    description:
  ...
  Destination(
    ...
    members: [members[0], members[2], members[1]],
    image:
        "https://upload.wikimedia.org/wikipedia/commons/f/fa/Annapurna_South-4588.jpg",
    facilities: [facilities[4], facilities[1], facilities[2], facilities[5]],
  ...
  Destination(
    ...
    image:
        "https://i.pinimg.com/736x/7b/70/0b/7b700b2d923f3a8c7f9cdc0f32284091.jpg",
    location: "India",
    description:
  ...
  Destination(
    ...
    image:
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/e6/39/8c/grand-hotel-kathmandu.jpg?w=700&h=-1&s=1",
    location: "KTM Nepal",
    description:
